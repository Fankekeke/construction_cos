...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Autowired
    private IArchivesInfoService articleService;
    ...
    public void regist(String username, String password, String name) throws Exception {
        ...
        ArchivesInfo archive = new ArchivesInfo();
        archive.setCode("AR-" + System.currentTimeMillis());
        archive.setName(name);
        archive.setCreateDate(DateUtil.formatDateTime(new Date()));
        archive.setUserId(user.getUserId().toString());
        articleService.save(archive);
