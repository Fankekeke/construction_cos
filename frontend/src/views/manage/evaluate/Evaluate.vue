<template>
  <a-card :bordered="false" class="card-area">
    ...
    <evaluate-view :evaluateShow="evaluateView.visiable" :evaluateData="evaluateView.data" @close="evaluateView.visiable = false"></evaluate-view>
  </a-card>
</template>
...
export default {
  name: 'evaluate',
  components: {evaluateAdd, evaluateEdit, evaluateView, RangeDate},
  data () {
    return {
      advanced: false,
      evaluateAdd: {
